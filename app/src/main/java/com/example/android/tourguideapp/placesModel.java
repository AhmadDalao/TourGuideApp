...
public class placesModel {
    ...
    public static ArrayList<placesModel> getShoppingList() {
        ...
        models.add(new placesModel("النور مول من المراكز العربية", " طريق الملك عبدالله الفرعي"));
